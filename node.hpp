...
struct Node_ {
public:
    Node_() : color(0), begin(0), left(this), right(this), parent(0), NIL(1), pair(new value_type()) {}
    Node_(const value_type& p) : color(0), begin(0), left(this), right(this), parent(0), NIL(0), pair(new value_type(p)) {}
    ~Node_() { delete pair; }
    bool color;
    struct Node_ *begin;
    struct Node_ *left;
